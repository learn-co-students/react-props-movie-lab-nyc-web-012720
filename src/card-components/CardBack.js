...
export default class CardBack extends Component {
  ...
  //   return <h4 className="genres">No Rating Found</h4> 
  //  }
  //  return <img src={imgMapper[this.props.IMDBRating]} alt="" /> 

  return this.props.IMDBRating === null ? <h4 className="genres">No Rating Found</h4> : <img src={imgMapper[this.props.IMDBRating]} alt="" /> 
